...
const initialLearningMetrics: LearningMetric[] = [
  { category: "C++", completed: 15, total: 20, color: "bg-green-400" },
  { category: "Python", completed: 8, total: 10, color: "bg-blue-400" },
  {
    category: "JavaScript",
    completed: 25,
    total: 30,
  ...
  { category: "RTOS", completed: 3, total: 8, color: "bg-red-400" },
];
