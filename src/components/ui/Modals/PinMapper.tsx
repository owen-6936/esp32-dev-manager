        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
              {esp32s3Pins.map((pin) => {
                const isAssigned = assignedPins.has(pin.pinNumber);
                const colorClass = isAssigned ? "bg-red-900" : "bg-white/10";
                const textClass = isAssigned ? "text-red-300" : "text-blue-200";
                ...
                return (
                  ...
                  >
                    ...
                    <div className={`${textClass} text-xs mt-1`}>
                      {statusText}
                    </div>
          ...
          <div>
            ...
            <div className="space-y-2">
              {currentProject?.pinConfig?.length ? (
                currentProject.pinConfig.map((config, index) => (
                  <div
                    key={index}
