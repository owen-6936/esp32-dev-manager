...
import { CalendarDays, AlertTriangle, Clock, CheckCircle, CalendarX } from "lucide-react";
            ...
            <div className="space-y-3">
                {withDeadline.length === 0 ? (
                    <div className="flex flex-col items-center gap-2 py-6 text-center">
                        <CalendarX className="w-8 h-8 text-white/15" />
                        <p className="text-white/30 text-sm">No upcoming deadlines</p>
                    </div>
                ) : (
                    withDeadline.map((project, i, arr) => {
                        ...
                        if (project.startDate) {
                            ...
                            progress = Math.max(0, Math.min(100, 100 - daysLeft * 5));
                        }
