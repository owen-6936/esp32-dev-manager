            ...
            >
               ...
               text-gradient animate-gradient drop-shadow-[0_0_8px_rgba(59,130,246,0.6)]"
                ...
                <p className="text-base sm:text-lg md:text-xl text-blue-200 mb-8 max-w-2xl mx-auto">
                    Complete project management, component tracking, learning
                    analytics, and community features for your ESP32 S3
                    development journey.
                </p>
                <div className="flex justify-center flex-wrap gap-4 items-center">
                    ...
                    {showPinMapper && (
                        <PinMapper setShowPinMapper={setShowPinMapper} />
                    )}
                    <Button
                        variant="classic"
                        className="py-5 px-8"
                    ...
                    {showPowerCalculator && (
                        <PowerCalculator
                            setShowPowerCalculator={setShowPowerCalculator}
                        />
                    )}
                    <Button
                        variant="classic"
