    ...
    <div className="space-y-6 min-h-full sm:min-h-screen p-6">
      <div className="flex flex-wrap items-center justify-center gap-4 sm:justify-between">
        ...
        <div className="flex space-x-2">
          <button
            ...
            className="bg-purple-500/20 text-purple-200 px-4 py-2 rounded-lg hover:bg-purple-500/30 transition-all flex items-center space-x-2"
          >
      ...
      {projects.length === 0 ? (
        <div className="flex flex-col items-center justify-center text-center text-blue-200 p-12 bg-white/5 rounded-xl border border-white/10">
          ...
          <button
            onClick={() => setShowAddProject(true)}
            className="mt-2 bg-gradient-to-r from-blue-500 to-purple-600 text-white px-4 py-2 rounded-lg hover:from-blue-600 hover:to-purple-700 transition-all shadow"
          >
            Add Project
          </button>
        </div>
